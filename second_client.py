...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 26 19:10:28 2021
...
def mine_block():
    ...
    blockchain.add_transaction(node_address, "Shyam", 10)  # 10 coins for mining
        ...
        jsonify(
            {
                ...
                "current_chain": str(blockchain.chain),
            }
        ),
        200,
    )
